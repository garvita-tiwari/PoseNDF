...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', '-c', default='configs/medium_fast.yaml', type=str, help='Path to config file.')
    parser.add_argument('--ckpt_path', '-ckpt', default='/BS/humanpose/static00/pose_manifold/amass/flip_medium_softplus_l1_0.0001_dist10.0_eik1.0/checkpoints/checkpoint_epoch_best.tar', type=str, help='Path to pretrained model.')
